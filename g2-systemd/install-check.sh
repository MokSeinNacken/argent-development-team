...
# I3-C1: the accepted live deployment advanced to the I3-B worktree (unit
# WorkingDirectory/Documentation re-pointed in the authorized Phase-I3-B deploy).
ARGENT_WORKTREE="${ARGENT_WORKTREE:-/home/pc/projects/argent-worktrees/phase-i3b-github-live-acceptance}"
ARGENT_DOC="${ARGENT_DOC:-file:${ARGENT_WORKTREE}/docs/PHASE_I3B_ACCEPTANCE.md}"
